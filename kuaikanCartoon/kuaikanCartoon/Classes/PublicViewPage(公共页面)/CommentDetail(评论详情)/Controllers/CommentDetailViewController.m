...
- (void)viewDidLoad {
    ...
    [self.cdv setRequestUrlWithIsNew:YES withRequestUrl:self.requestID];
}
...
{
    [self.cdv setRequestUrlWithIsNew:!sc.selectedSegmentIndex withRequestUrl:self.requestID];
}
